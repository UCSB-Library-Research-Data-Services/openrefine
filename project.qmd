...
When you launch OpenRefine by clicking the diamond logo or accessing [http://127.0.0.1:3333](http://127.0.0.1:3333/) you'll presented with a home screen with some options, among which to start a new project. Let's explore some of these options together before proceeding:
...
By default, OpenRefine autosaves your project every five minutes. If you'd like you can adjust this setting using the command line and following the instructions laid out [here](https://openrefine.org/docs/manual/running#jvm-preferences).
...
We will keep the default configuration for now, but you can customize the desired location by following these [instructions](https://openrefine.org/docs/manual/installing#set-where-data-is-stored).
