...
[^2]: Rawson, K., & Muñoz, T. (2016, July 7). Against cleaning. *Curating Menus*. http://www.curatingmenus.org/articles/against-cleaning
...
We also encourage learners to also explore our handouts from our [Data Literacy Series](https://rcd.ucsb.edu/data-literacy-series) with practical recommendations on related topics, including: handling [missing data](https://perma.cc/4ZWA-NSJD), dealing with [encoding issues](https://perma.cc/Q42N-M5YK), keeping [spreadsheets organized](https://perma.cc/5LBN-YQDU) and [control for quality in tabular data](https://perma.cc/MJ2A-N3YQ).
